...
<div class="col-sm-12">
    ...
    <ul class="ifa-users list-unstyled">
        <li><a href="{{ route('ifa_registration.create')}}" class="btn btn-primary">New Application</a></li>
        <li><a href="{{ route('ifa_registration.edit') }}" class="btn btn-primary">Existing Application</a></li>
    </ul>
