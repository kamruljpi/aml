	...
	<div class="header">
		<div class="panel panel-default ">
			<div class="panel-heading">
				<center><h2>Nationality Update Page</h2></center>
			</div>
		</div>
	</div>
	...
	<div class="panel-body">
		...
		<div class="col-sm-8 col-sm-offset-2">
			<div class="panel panel-default add_body">
				<div class="panel-body">
					@foreach($findNationality as $findvalue)
					<form action="{{route('nationalitys.update',[$findvalue->id_nationality])}}" method="POST">
						...
						{!! method_field('PUT') !!}
							...
							<div class="form-group add_input{{ $errors->has('nationality') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="nationality" value="{{ $findvalue->nationality}}">
