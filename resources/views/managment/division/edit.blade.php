	...
	<div class="header">
		<div class="panel panel-default ">
			<div class="panel-heading">
				<center><h2>Division Update Page</h2></center>
			</div>
		</div>
	</div>
	...
	<div class="panel-body">
		...
		<div class="col-sm-8 col-sm-offset-2">
			<div class="panel panel-default add_body">
				<div class="panel-body">
					@foreach($findDivision as $findvalue)
					<form action="{{route('divisions.update',[$findvalue->division_id])}}" method="POST">
						...
						{!! method_field('PUT') !!}
							...
							<div class="form-group add_input{{ $errors->has('division_name') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="division_name" value="{{ $findvalue->division_name}}">
